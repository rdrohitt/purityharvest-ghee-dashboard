...
import { type Followup, isFollowupHistoryEntryDeletable } from '../../utils/followups';
...
export function FollowupCallHistoryModal({
    ...
    const [historyEntryIdPendingDelete, setHistoryEntryIdPendingDelete] = useState<string | null>(null);
    ...
    const entryPendingDelete = useMemo(
        () => (historyEntryIdPendingDelete ? timeline.find((e) => e.id === historyEntryIdPendingDelete) : null),
                                                ...
                                                <div className="fu-hist-timeline__head-right">
                                                    ...
                                                    {canDelete ? (
                                                        <button
                                                            ...
                                                            onClick={() => setHistoryEntryIdPendingDelete(entry.id)}
                                                        >
                                                            {rowDeleting ? (
                                                                <Spinner size="sm" />
                                                            ) : (
                    ...
                    entryPendingDelete ? (
                        <>
                            ...
                            <div className="delete-modal-customer-name">
                                ...
                                {entryPendingDelete.callerName ? ` · ${entryPendingDelete.callerName}` : ''}
                            </div>
